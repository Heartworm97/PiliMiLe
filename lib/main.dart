...
import 'package:PiliMiLe/common/widgets/back_detector.dart';
...
import 'package:PiliMiLe/router/app_pages.dart';
...
import 'package:PiliMiLe/utils/calc_window_position.dart';
import 'package:PiliMiLe/utils/date_utils.dart';
import 'package:PiliMiLe/utils/extension/theme_ext.dart';
import 'package:PiliMiLe/utils/json_file_handler.dart';
...
void main() async {
  ...
  SmartDialog.config.loading = SmartConfigLoading(leastLoadingTime: const Duration(milliseconds: 1000));
